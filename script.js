...
const funk_pricol = ()=>{
   ...
   console.log(temp_prikol)
    ...
    inp_prikol.innerHTML = '<img src="image/icons/ded_moroz.png" alt=""></img>'
    };
    for (i=5;i<=8;i++) {
        let temp_prikol = 's'+i
     console.log(temp_prikol)
      const inp_prikol = document.getElementById(temp_prikol);
      inp_prikol.innerHTML = '<img src="image/icons/olen80.png" alt=""></img>'
      }
  }
...
if(check_click >= 5){
    ...
    inp_prikol1.innerHTML = '<img src="https://i.gifer.com/4s2P.gif" alt=""></img>'
}
}
prikol.onclick =()=>{
    check_click++
